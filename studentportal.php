...
<div class="container">
	<nav class="navbar navbar-inverse navbar-fixed-top">
		...
		<div class="container_fluid">
			...
			<p class="page-header center-block">
				<a href="https://goo.gl/maps/vVarTHvx56dYNLAq6" target="_blank"><button class="btn btn-primary">Contact Us</button></a>
				<a href="https://en.wikipedia.org/wiki/Library" target="_blank"t><button class="btn btn-info">About Us</button></a>
